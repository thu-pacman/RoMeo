...
def invoke_fused_moe_kernel(A: torch.Tensor,
    ...
    chunk_size = config['BLOCK_SIZE_M']
    qfactory.fused_moe_fp8_fp8_bf16_nt(
        num_tokens_post_padded // chunk_size,
        (A, A_scale),
        (B, B_scale),
        C.view(-1, B.shape[1]),
        sorted_token_ids,
        ...
        block_n,
        block_k,
        topk_weights.reshape(-1, top_k) if mul_routed_weight else None
    )
    # import torch
    # torch.save(
    #     (
