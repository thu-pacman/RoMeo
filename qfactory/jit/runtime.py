...
Python2CTypes = {
    NoneType: ctypes.c_void_p,
    torch.int32: ctypes.c_void_p,
    torch.float32: ctypes.c_void_p,
    torch.float16: ctypes.c_void_p,
    torch.bfloat16: ctypes.c_void_p,
    torch.float8_e4m3fn: ctypes.c_void_p,
    torch.uint8: ctypes.c_void_p,
